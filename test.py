...
# myconn = mysql.connector.connect(host="sql6.freemysqlhosting.net",user='sql6524884', passwd = 'dmFL41B4Xt')
...
class travel:
    ...
    def __init__(self, root):
        ...
        self.chkStandard = Radiobutton(Book_Frame, text="Standard Cab", value=1, variable=carType,
        ...
        self.chkFordGalaxyd = Radiobutton(Book_Frame, text="Ford Galaxy Cab", value=2, variable=carType,
        ...
        self.chkFordMondeo = Radiobutton(Book_Frame, text="Ford Mondeo Cab", value=3, variable=carType,
